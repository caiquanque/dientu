...
<table class="form-table">
	<tbody>
		...
		<tr>
			...
			<td>
				<input type="text" id="chimpbridge-from-name" name="_chimpbridge_from_name" value="<?php echo esc_html( $chimpbridge_from_name_form_value ); ?>">
		...
		<tr>
			...
			<td>
				<input type="email" id="chimpbridge-from-email" name="_chimpbridge_from_email" value="<?php echo esc_html( $chimpbridge_from_email_form_value ); ?>">
		...
		<tr>
			...
			<td>
				<input type="text" id="chimpbridge-from-name" name="_chimpbridge_to_name" value="<?php echo esc_html( $chimpbridge_to_name_form_value ); ?>">
		...
		<?php if ( ! class_exists( 'ChimpBridgePro' ) ): ?>
			<tr>
				...
				<td>
					<p><?php echo apply_filters( 'chimpbridge_msg_segments_help', sprintf( esc_html__( '%sUpgrade to ChimpBridge Pro%s to customize the footer to match your brand', 'chimpbridge' ), '<a target="_blank" href="https://chimpbridge.com/?utm_source=plugin&utm_campaign=footer-help">', '</a>' ) ); ?></p>
				</td>
			</tr>
		<?php endif; ?>
