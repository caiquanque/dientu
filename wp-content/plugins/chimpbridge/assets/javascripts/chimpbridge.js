...
function chimpbridge_verify_campaign_valid() {
    if ( jQuery('#chimpbridge-select-lists').find(':selected').text() == chimpbridge_general_localized_strings["Select a list"] ) {
        alert( chimpbridge_general_localized_strings["Please select a list."] );
        return false;
    }
    if ( jQuery('#chimpbridge-select-segments').find(':selected').text() == chimpbridge_general_localized_strings["Select a segment"] ) {
        alert( chimpbridge_general_localized_strings["Please select a list segment (or choose to send this campaign to the entire list)."] );
        return false;
    }
    if ( jQuery.trim( jQuery('#title').val() ) == '' ) {
        alert( chimpbridge_general_localized_strings["Enter a subject"] );
        return false;
    }
    return true;
}
